...
O sistema foi desenvolvido utilizando Java com arquitetura MVC e padrão DAO, garantindo organização, escalabilidade e facilidade de manutenção.
...
💡 Controle de estoque com lógica de negócio aplicada
💡 Estrutura organizada (MVC + DAO)
💡 Base pronta para evolução (BI e dashboards)
💡 Aplicável a qualquer varejo
